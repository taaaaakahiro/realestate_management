...
// registrationFee（登記費用）は自動計算せず、登録時に手入力する値。
// モックデータでは各物件に固定値を設定する。
